<?php
	...
	if($acao == "alterar"){
		$sql = "UPDATE $TBL SET ajuda = '$texto'"; 
		mysql_query($sql, $cx);
...
<form method="post" action="form_ajuda.php" name="frm_noticias" enctype="multipart/form-data">
<fieldset><legend>Ajuda</legend>
<table border="0">
    <tr>
        <td>
        	<?php 
