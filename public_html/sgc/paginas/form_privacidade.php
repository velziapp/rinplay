<?php
	...
	if($acao == "alterar"){
		$sql = "UPDATE $TBL SET privacidade = '$texto'"; 
		mysql_query($sql, $cx);
...
<form method="post" action="form_privacidade.php" name="frm_noticias" enctype="multipart/form-data">
<fieldset><legend>Privacidade</legend>
<table border="0">
    <tr>
        <td>
        	<?php 
			...
			$oFCKeditor->Value = $ln["privacidade"];
