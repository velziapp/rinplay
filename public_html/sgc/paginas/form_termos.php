<?php
	...
	if($acao == "alterar"){
		$sql = "UPDATE $TBL SET termos = '$texto'"; 
		mysql_query($sql, $cx);
...
<form method="post" action="form_termos.php" name="frm_noticias" enctype="multipart/form-data">
<fieldset><legend>Termos</legend>
<table border="0">
    <tr>
        <td>
        	<?php 
