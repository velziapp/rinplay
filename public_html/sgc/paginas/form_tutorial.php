<?php
	...
	if($acao == "alterar"){
		$sql = "UPDATE $TBL SET tutorial = '$texto'"; 
		mysqli_query( $cx, $sql);
...
<form method="post" action="form_tutorial.php" name="frm_noticias" enctype="multipart/form-data">
<fieldset><legend>Tutorial</legend>
<table border="0">
    <tr>
        <td>
        	<?php 
