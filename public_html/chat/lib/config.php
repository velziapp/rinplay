...
// Database hostname:
$config['dbConnection']['host'] = 'companhiapixel.com.br';
// Database username:
$config['dbConnection']['user'] = 'ciauser';
// Database password:
$config['dbConnection']['pass'] = 'c1i2a3p4';
// Database name:
$config['dbConnection']['name'] = 'ciapixel';
// Database type:
...
// Default style:
$config['styleDefault'] = 'subsilver2';
...
$config['defaultChannelName'] = 'Publica';
