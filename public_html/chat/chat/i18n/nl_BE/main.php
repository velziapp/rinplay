...
$GLOBALS["i18n"]["Private message"] = "Priv&eacute;-bericht";
...
$GLOBALS["i18n"]["Maximum number of private chat has been reached"] = "Het maximum aantal priv&eacute;-chats is bereikt";
...
$GLOBALS["i18n"]["%s doesn't exist, data_public_path cannot be installed"] = "%s bestaat niet, data_public_path kan niet ge&iuml;nstalleerd worden";
...
$GLOBALS["i18n"]["cannot copy %s in %s"] = "kan %s niet in %s kopi&euml;ren";
