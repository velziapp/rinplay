...
$GLOBALS["i18n"]["Disconnect"] = '切断';

// line 395 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Connect"] = '接続';

// line 427 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Magnify"] = '拡大';
...
$GLOBALS["i18n"]["banished from %s by %s"] = '%1$s さんにより、%2$s から禁止されました。';
...
$GLOBALS["i18n"]["Chosen nickname is already used"] = '選択したニックネームは既に使用されています';
...
$GLOBALS["i18n"]["'/unban {nickname}' will unban the user identified by {nickname}"] = '「/unban {nickname}」は{nickname}のユーザの禁止を解除します';
...
$GLOBALS["i18n"]["%s banished from %s by %s"] = '%1$s は %3$s により、%2$s から追放されました';
