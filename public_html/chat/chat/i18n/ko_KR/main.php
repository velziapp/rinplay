...
/**
 * Korean translation of the messages..
 *
 * @author Kim Taeho (taehos@gmail.com)
 */
...
$GLOBALS["i18n"]["%s doesn't exist: %s"] = "%s 는 존재하지 않습니다 : %s";

// line 180 in phpfreechatconfig.class.php
$GLOBALS["i18n"]["You need %s"] = "%s 가 필요합니다.";

// line 241 in phpfreechatconfig.class.php
$GLOBALS["i18n"]["%s doesn't exist, %s library can't be found"] = "%s 를 찾을 수 없습니다, %s 라이브러리가 로드되지 않았습니다.";
...
$GLOBALS["i18n"]["%s can't be created"] = "%s 는 생성될 수 없습니다.";

// line 451 in phpfreechatconfig.class.php
$GLOBALS["i18n"]["%s is not writeable"] = "%s 에 기록할 수 없습니다.";

// line 496 in phpfreechatconfig.class.php
$GLOBALS["i18n"]["%s is not readable"] = "%s 를 읽을수 없습니다.";

// line 469 in phpfreechatconfig.class.php
$GLOBALS["i18n"]["%s is not a file"] = "%s 는 파일이 아닙니다.";

// line 491 in phpfreechatconfig.class.php
$GLOBALS["i18n"]["%s is not a directory"] = "%s 는 디렉토리가 아닙니다.";
...
$GLOBALS["i18n"]["Hide nickname marker"] = "닉네임에 색상 사용하지 않기";

// line 304 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Show nickname marker"] = "닉네임에 색상 사용하기";

// line 389 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Disconnect"] = "연결 해제";

// line 395 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Connect"] = "연결";

// line 427 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Magnify"] = "확대";

// line 434 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Cut down"] = "자르기";

// line 345 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Hide dates and hours"] = "날짜와 시간 숨기기";

// line 353 in javascript1.js.tpl.php
$GLOBALS["i18n"]["Show dates and hours"] = "날짜와 시간 표시하기";

// line 21 in chat.html.tpl.php
$GLOBALS["i18n"]["Enter your message here"] = "여기에 대화를 입력하세요";
...
$GLOBALS["i18n"]["Show smiley box"] = "이모티콘 보이기";

// line 88 in pfcclient.js.tpl.php
$GLOBALS["i18n"]["Hide online users box"] = "현재 접속자 숨기기";

// line 89 in pfcclient.js.tpl.php
$GLOBALS["i18n"]["Show online users box"] = "현재 접속자 보이기";

// line 33 in chat.html.tpl.php
$GLOBALS["i18n"]["Bold"] = "굵게";

// line 34 in chat.html.tpl.php
$GLOBALS["i18n"]["Italics"] = "이탤릭";

// line 35 in chat.html.tpl.php
$GLOBALS["i18n"]["Underline"] = "밑줄";

// line 36 in chat.html.tpl.php
$GLOBALS["i18n"]["Delete"] = "취소선";

// line 37 in chat.html.tpl.php
$GLOBALS["i18n"]["Pre"] = "Pre";

// line 38 in chat.html.tpl.php
$GLOBALS["i18n"]["Mail"] = "메일주소";

// line 39 in chat.html.tpl.php
$GLOBALS["i18n"]["Color"] = "색상";

// line 48 in phpfreechattemplate.class.php
$GLOBALS["i18n"]["%s template could not be found"] = "%s 템플릿을 찾을 수 없습니다.";

// line 512 in phpfreechatconfig.class.php
$GLOBALS["i18n"]["Error: '%s' could not be found, please check your themepath '%s' and your theme '%s' are correct"] = "Error: '%s' 를 찾을 수 없습니다. 테마의 위치인 '%s' 를 찾아보시고 지정한 테마가 '%s' 가 맞는지 확인하세요";

// line 75 in pfccommand.class.php
$GLOBALS["i18n"]["%s must be implemented"] = "%s 는 권한이 있어야만 합니다.";
...
$GLOBALS["i18n"]["Close this tab"] = "이 탭 닫기";

// line 225 in pfcgui.js.tpl.php
$GLOBALS["i18n"]["Do you really want to leave this room ?"] = "이 채널을 떠나길 원하십니까?";
...
$GLOBALS["i18n"]["%s users have been unbanished"] = "%s 님은 추방이 취소 되어 있습니다.";

// line 47 in auth.class.php
$GLOBALS["i18n"]["You are not allowed to run '%s' command"] = "'%s'명령을 실행할 권한이 없습니다.";

// line 67 in auth.class.php
$GLOBALS["i18n"]["Can't join %s because you are banished"] = "%s 에 참여할수 없습니다(강퇴)";

// line 79 in auth.class.php
$GLOBALS["i18n"]["You are not allowed to change your nickname"] = "닉을 바꿀 권한이 없습니다.";
...
$GLOBALS["i18n"]["'%s' directory doesn't exist"] = "'%s' 디렉토리가 존재하지 않습니다.";

// line 544 in pfcglobalconfig.class.php
$GLOBALS["i18n"]["Please correct these errors"] = "위 오류를 수정해 주시기 바랍니다.";

// line 21 in pfcinfo.class.php
$GLOBALS["i18n"]["Error: the cached config file doesn't exists"] = "오류 : 저장된 설정이 존재하지 않습니다.";
...
$GLOBALS["i18n"]["Here is the command list:"] = "명령어 목록:";

// line 63 in identify.class.php
$GLOBALS["i18n"]["Succesfully identified"] = "성공적으로 인증됨";

// line 68 in identify.class.php
$GLOBALS["i18n"]["Identification failure"] = "인증 실패";

// line 25 in send.class.php
$GLOBALS["i18n"]["Your must be connected to send a message"] = "메세지를 보내려면 연결해야 합니다.";

// line 87 in chat.js.tpl.php
$GLOBALS["i18n"]["Click here to send your message"] = "여기를 눌러 메세지를 보내세요";

// line 80 in chat.js.tpl.php
$GLOBALS["i18n"]["Enter the text to format"] = "형식화 할 글자를 넣으세요..";

// line 81 in chat.js.tpl.php
$GLOBALS["i18n"]["Configuration has been rehashed"] = "재설정";
...
$GLOBALS["i18n"]["Maximum number of joined channels has been reached"] = "최대 방 인원에 도달하였습니다.";
