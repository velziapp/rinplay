...
$GLOBALS["i18n"]["Input Required"] = "Veuillez répondre";
...
$GLOBALS["i18n"]["You are trying to speak to a unknown (or not connected) user"] = "Vous essayez de parler à un utilisateur inconnu (ou inconnu)";
