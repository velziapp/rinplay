        ...
        <div id="lateral-esquerda">
            ...
            <ul>
            	<?php 
				if($edono){	
					echo "<li><img src='img/editar.png' align='absmiddle'> <a href='javascript:mostraAlterar();'>Editar</a></li>";
				}
				if($edono){	
					echo "<li><img src='img/lixeira.png' align='absmiddle'> <a href='minhas-comunidades.php?acao=excluirComunidade&codigo_comunidade=".$codigo_comunidade."'>Excluir</a></li>";
				}
				if($fazparte){
					echo "<li><img src='img/plus.gif' align='absmiddle'> <a href='comunidade-topico.php?codigo_comunidade=".$codigo_comunidade."'>Fórum</a></li>";
					if(!$edono){
						echo "<li><img src='img/iconSair.png' align='absmiddle'> <a href='comunidade-perfil.php?acao=deixar&codigo_comunidade=".$codigo_comunidade."'>Abandonar</a></li>";
					}
				}
				if(!$fazparte){	
					echo "<li><img src='img/entrar.png' align='absmiddle'> <a href='comunidade-perfil.php?acao=participar&codigo_comunidade=".$codigo_comunidade."'>Participar</a></li>";
				}
				?>	
            	<li><img src="img/sair.png" align="absmiddle"> <a href="comunidade.php">Retornar</a></li>
            </ul>
            <br />
			...
			if(mysql_num_rows($rs) > 0):
				...
				?>
					<li><a href="verPerfil.php?codigo_user=<?php echo $linha['codigo_user']; ?>"><img src="sgc/uploads/fotos/<?php echo $linha['foto']; ?>" height="36" width="36" border="0" title="<?php echo $linha['nome']; ?>"></a></li>
				<?php 
				} 
			else:
