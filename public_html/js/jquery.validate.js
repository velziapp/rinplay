...
$.extend($.validator, {
	...
	defaults: {
		...
		groups: {},
		rules: {},
		errorClass: "errorValidade",
		validClass: "validValidade",
		errorElement: "label",
		focusInvalid: true,
		errorContainer: $( [] ),
		errorLabelContainer: $( [] ),
	...
	messages: {
		...
		dateISO: "Por favor, informe uma data no formato (ISO).",
		number: "Por favor insira um n&uacute;mero v&aacute;lido.",
		digits: "Por favor, insira apenas d&iacute;gitos.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Por favor digite o mesmo valor novamente.",
		accept: "Extensão inv&aacute;lida.",
		maxlength: $.validator.format("O campo deve conter no m&aacute;ximo {0} caracteres."),
		minlength: $.validator.format("O campo deve conter no m&iacute;nimo {0} caracteres."),
